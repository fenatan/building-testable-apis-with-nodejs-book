...
describe('Controllers: Products', () => {
    ...
    describe('getById()', () => {
        it('should return one product', async () => {
            ...
            //Simulando chamada ao Banco de dados
            Product.find = sinon.stub();
    ...
    describe('create() product', () => {
        it('should save a new product successfully', async () => {
            const requesWithBody = Object.assign(
                {},
            ...
            //Essa função simula a ação de salvar no banco de dados
            sinon
            ...
            await productsController.create(requesWithBody, response);
